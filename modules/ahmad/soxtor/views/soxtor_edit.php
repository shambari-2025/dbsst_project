							...
							<div class="card">
								...
								<div class="card-block">
									...
									<div class="table-responsive davrifaol">
										<!--PHP Script-->
										<form action="<?=MY_URL?>?option=soxtor&action=soxtor_update" method="POST">
											<?php// print_arr($info);?>
											<table>
												<tr>
													<td><label name="name">Ном: </label></td>
													<td><input type="text" name="name" value="<?=$info[0]['name']?>"></td>
												</tr>
												<tr>
													<td><label name="name_short_tj">Номи кутоҳ(тоҷикӣ): </label></td>
													<td><input type="text" name="name_short_tj" value="<?=$info[0]['name_short_tj']?>"></td>
												</tr>
												<tr>
													<td><label name="name_short_ru">Номи кутоҳ(русӣ): </label></td>
													<td><input type="text" name="name_short_ru" value="<?=$info[0]['name_short_ru']?>"></td>
												</tr>
												<tr>
													<td><label name="name_full_tj">Номи пурра(тоҷикӣ): </label></td>
													<td><input type="text" name="name_full_tj" value="<?=$info[0]['name_full_tj']?>"></td>
												</tr>
												<tr>
													<td><label name="name_full_ru">Номи пурра(русӣ): </label></td>
													<td><input type="text" name="name_full_ru" value="<?=$info[0]['name_full_ru']?>"></td>
												</tr>
												<tr>
													<td><label name="detail_tj">Detail(тоҷикӣ): </label></td>
													<td><input type="text" name="detail_tj" value="<?=$info[0]['detail_tj']?>"></td>
												</tr>
												<tr>
													<td><label name="detail_ru">Detail(русӣ): </label></td>
													<td><input type="text" name="detail_ru" value="<?=$info[0]['detail_ru']?>"></td>
												</tr>
												<tr>
													<td colspan="2">
