										...
										<table class="table" style="font-size:14px">
											<thead class="center">
												<tr style="background-color: #263544; color: #fff">
													...
													<th style="width:500px">Номгӯи факултетҳо</th>
													<th style="width:70px">Миқдори<br>ихтсосҳо</th>
													<th style="width:170px">Декан</th>
													<th>Амалҳо</th>
												</tr>
											</thead>
											<tbody class="center">
												<?php if(!empty($faculties)):?>
													...
													<?php foreach($faculties as $item):?>
														<tr>
															...
															<th scope="row"><?=$item['id_faculty']?></th>
															<td class="left">
																<a href="<?=MY_URL?>?option=soxtor&action=specs_list&id=<?=$item['id_faculty']?>">
																<?=$item['title']?>
																</a>
															</td>
															...
															<th scope="row">
																<?=$item['specs']?>
																<?//=count_table_where("specialties", "`id_faculty` = '".$item['id']."'")?>
															</th>
															
															<td class="left">
																<?php if($item['id_decan']):?>
																	<?=getShortName($item['id_decan'])?>
																<?php endif;?>
															</td>
															
															
															<td class="elements">
																<a class="edit" href="javascript" data-toggle="modal" data-target=".bs-example-modal-lg" data-id="<?=$item['id_faculty']?>"><i class="fa fa-edit"></i> </a>
