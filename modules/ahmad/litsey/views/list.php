									...
									<table class="table" style="font-size: 14px !important">
										<thead class="center">
											<tr style="background-color: #263544; color: #fff">
												...
												<th class="left">Суроға</th>
												<th class="left">Маблағи таҳсил</th>
												<th class="left">Пардохт шуд!</th>
												<th class="left">Бақия</th>
												
												<th>Амалҳо</th>
											</tr>
										</thead>
										<tbody class="center" id="tbody">
											<?php $money_s = $money_q = 0;?>
											<?php $counter = $mans  = 0;?>
											...
											<?php foreach($students as $item):?>
												...
												<tr id="student_<?=$item['id']?>">
													...
													<td>
														<?php $photo = getUserImg($item['id'], $item['jins'], $item['photo'], 4);?>
													...
													<td class="left">
														...
														<?php if(isset($item['vazi_oilavi']) > 1):?>
															<br>
														...
														<div class="dropdown-inverse dropdown open">
															...
															<div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
																...
																<a data-toggle="modal" data-target=".bs-example-modal-lg" data-id-student="<?=$item['id']?>" data-name="<?=$item['fullname_tj']?>"
																	class="dropdown-item waves-light waves-effect student_rasid" href="javascript:">
																...
																<a class="dropdown-item waves-light waves-effect" onclick="return confirmDel()"
																href="<?=MY_URL?>?option=litsey&action=delete_xonanda&id=<?=$item['id']?>">
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('.student_rasid').on('click', function(){
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/bugalteria/bugalteria_ajax.php?option=getShartnomaForm";?>';
