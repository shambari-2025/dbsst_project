<form action="<?=MY_URL?>?option=bugalteria&action=insert_hisob_varaqa" method="post" enctype="multipart/form-data">
	<table class="addform">
		<tr>
			...
			<td>
				<label for="payed_from">Номи муассиса:</label>
				<input required autocomplete="off" type="text" name="payed_from" id="payed_from" class="form-control">
			</td>
			
			<td>
				<label for="check_date">Санаи таҳвил:</label>
				<input autocomplete="off" type="date" name="check_date" id="check_date" class="form-control">
			</td>
		</tr>
