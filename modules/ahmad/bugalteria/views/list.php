											...
											<?php foreach($students as $item):?>
												...
												<tr id="student_<?=$item['id']?>">
													...
													<?php if($item['id_s_t'] == 1):?>
														...
														<td class="center">
															<?php $sh_money = getSharnomaMoneyBySY($item['id_course'], $item['id_spec'], $item['id_s_l'], $item['id_s_v'], S_Y, $item['foreign']);?>
															<?=$sh_money?>
														</td>
														<td class="center">
														...
														<div class="dropdown-inverse dropdown open">
															...
															<div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
																...
																<a data-toggle="modal" data-target=".bs-example-modal-lg" data-id-student="<?=$item['id']?>" data-name="<?=$item['fullname_tj']?>" data-foreign="<?=$item['foreign']?>"
																	...
																	<i class="fa fa-list-alt"></i> Иловакунии расид
																</a>
																
																
																<a data-toggle="modal" data-target=".bs-example-modal-lg" data-id-student="<?=$item['id']?>" data-name="<?=$item['fullname_tj']?>" data-foreign="<?=$item['foreign']?>"
																	class="dropdown-item waves-light waves-effect add_hisobvaraqa" href="javascript:">
																	<i class="fa fa-bank"></i> Иловакунии ҳисобварақа
																</a>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		/* ҲИСОБВАРАҚА */
		$('.add_hisobvaraqa').on('click', function(){
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/{$option}/{$option}_ajax.php?option=getHisobVaraqaForm";?>';
