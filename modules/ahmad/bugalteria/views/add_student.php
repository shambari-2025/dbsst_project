						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-block">
									...
									<form name="add_form" action="<?=MY_URL?>?option=bugalteria&action=insert_student" method="post" enctype="multipart/form-data">
										<table class="addform">
											<tr>
												<td colspan="2">
											...
											<tr>
												...
												<td>
													...
													<input required autocomplete="off" type="text" name="maqomot" id="maqomot" class="form-control">
												</td>
											</tr>
											...
											<tr>
												<td colspan="3">
													...
													<textarea required rows="5" style="width:100%" name="family_info" id="family_info" class="form-control">Падар - Модар -</textarea>
												</td>
											</tr>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('.addform').on("change", "#id_spec, #id_s_l, #id_s_v, #foreign", function () {
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/commission/commission_ajax.php?option=getShartnomaMoney";?>';
		...
		$('.addform').on("change", "#id_course", function () {
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/commission/commission_ajax.php?option=getSemestr";?>';
		...
		$("#fullname").blur(function() {
			...
			var url = '<?=URL."modules/commission/commission_ajax.php?option=makeLogin";?>';
			...
			var url = '<?=URL."modules/commission/commission_ajax.php?option=getMMTNumber";?>';
		...
		$('.addform').on("change", "#id_country", function () {
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/commission/commission_ajax.php?option=getRegions";?>';
		...
		$('.addform').on("change", "#id_region", function () {
			...
			var my_url = '<?=MY_URL;?>';
			var url = '<?=URL."modules/commission/commission_ajax.php?option=getDistricts";?>';
