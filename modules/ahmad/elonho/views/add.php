						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?=MY_URL?>?option=elonho&action=insert" method="post" enctype="multipart/form-data">
										<table class="addform">
											<tr>
												<td>
													<label for="type">Ба ки:</label>
													<select name="type" id="type" class="form-control" required>
														<option value="3">Ба ҳама</option>
														<option value="2">Ба омӯзгорон</option>
														<option value="1">Ба донишҷӯён</option>
													</select>
												</td>
											</tr>
