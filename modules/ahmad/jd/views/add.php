									...
									<form action="<?=MY_URL?>?option=jd&action=insert" method="post" enctype="multipart/form-data">
										<table class="addform">
											<tr>
												...
												<td colspan = "1">
													<label for="bast">Басти факултетро интихоб кунед:</label>
													<select name="bast" id="bast" class="form-control">
														<option value="1">Басти 1-ум</option>
														<option value="2">Басти 2-юм</option>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('.addform').on("change", "#faculty, #course, #id_s_l, #s_y, #h_y", function () {
			...
			$.ajax({
				...
				data: {"my_url": my_url, "id_faculty":id_faculty, "id_course": id_course, "id_s_l": id_s_l, "s_y": s_y, "h_y": h_y},
