										...
										<tbody class="center" id="tbody">
											...
											<?php foreach($qarzdorho as $item):?>
												<tr class="center">
													...
													<td>
														<?php if($item['nf_score'] < 25):?>
															Иҷозат надошт
														<?php elseif($item['imt_score'] > 0):?>
															Иштирок кард
														<?php else:?>
															Наомад
														<?php endif;?>
											...
											<tr class="bold center">
												<td colspan="14" style="text-align:right">Ҳамаги маблағ:</td>
