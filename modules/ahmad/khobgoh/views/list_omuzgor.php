															...
															<?php if($item['access_type'] != 1 || $item['id'] == $_SESSION['user']['id']):?>
																...
																<div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
																	<a data-toggle="modal" data-target=".bs-example-modal-lg" data-id-teacher="<?=$item['id']?>" data-name="<?=$item['fullname_tj']?>"
																		class="dropdown-item waves-light waves-effect teacher_khobgoh" href="javascript:">
																		<i class="fa fa-edit"></i> Илова намудан ба хобгоҳ
																	</a>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('.teacher_khobgoh').on('click', function(){
			var id_user = $(this).attr("data-id-teacher");
