	...
	<div class="pcoded-inner-content">
		<div class="main-body">
			<div class="page-wrapper">
				<div class="page-body">
					<div class="row">
						<form action="<?=MY_URL?>?option=sessions&action=result_r" method="post" name="forma" enctype="multipart/form-data" style="width: 100%" onkeypress="if(event.keyCode == 13) return false;">
							<?php $counter = 0;?>
