...
<div class="pcoded-content">
	...
	<?php if(isset($_SESSION['shurbo'])):?>
		<div class="alert alert-warning alert-dismissable growl-animated animated fadeInDown myalert">
			<i class="fa fa-warning"></i> <?=$_SESSION['shurbo']?>
		</div>
		<?php unset($_SESSION['shurbo']);?>
	<?php endif;?>
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<?php if($id_s_t == 1):?>
										...
										?>
										<?php if($mablagi_shartnoma > $mablag_suporid):?>
											<div class="alert alert-warning alert-dismissable growl-animated animated fadeInDown myalert">
									...
									<?php if($flag):?>
										...
										<?php if($fanho):?>
											<form action="<?=MY_URL?>?option=sessions&action=suporidan" method="post" enctype="multipart/form-data">
