...
switch($action){
	...
	case "save_trimestr":
		...
		$id_nt = query("SELECT `id_nt` FROM `std_study_groups` WHERE `id_faculty` = '$id_faculty' AND `id_s_l` = '$id_s_l' AND `id_s_v` = '$id_s_v' AND `id_course` = '$id_course' AND `id_spec` = '$id_spec' AND `id_group` = '$id_group' AND `s_y` = '$S_Y' AND `h_y` = '$H_Y'");
		$id_nt = $id_nt[0]['id_nt'];
		...
		// $qarzho = query("SELECT *,IFNULL(IF(`results`.`total_score` IS NULL, 0, `results`.`total_score`), 0) as `score_total` 
		// FROM `results` 
		// WHERE `id_faculty` = '$id_faculty' AND `id_s_l` = '$id_s_l' AND 
		// `id_s_v` = '$id_s_v' AND `id_course` = '$id_course' AND `id_spec` = '$id_spec' 
		// AND `id_group` = '$id_group' AND `id_student` = '$id_student'  
		// AND `id_fan` IN ($fans) AND `trimestr_score` IS NULL 
		// AND `s_y` = '$S_Y' AND `h_y` = '$H_Y'
		// HAVING
			// `score_total` < 50.00 
		// ");
		...
		$id_trimestr = insert("trimestr", $fields, $data, 1);				
		...
		foreach($qarzho as $q){
			...
			// $test = query("SELECT * FROM `tests` WHERE `id_faculty` = '$id_faculty' AND `id_s_l` = '$id_s_l' AND `id_s_v` = '$id_s_v' AND `id_course` = '$id_course' AND `id_spec` = '$id_spec' AND `id_group` = '$id_group' AND `id_fan` = '$id_fan' AND `s_y` = '$S_Y' AND `h_y` = '$H_Y'");
			...
			// $id_teacher = query("SELECT `id_teacher` FROM `sarboriho` 
