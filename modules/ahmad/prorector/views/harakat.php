									...
									<tbody>
										...
										<?php foreach($_SESSION['superarr'] as $f_item):?>
											...
											<?php foreach($f_item['level'][$l]['view'] as $v_item):?>
												...
												<?php foreach($v_item['course'] as $c_item):?>
													...
													<?php foreach($c_item['spec'] as $s_item):?>
														...
														<?php foreach($s_item['groups'] as $g_item):?>
															<tr class="center">
																...
																<td><?=++$counter;?>.</td>
																<td><?=$c_item['id']?></td>
																<td><?=$s_item['code']?> <?=$g_item['title']?></td>
													...
													<tr class="center bold" style="border-bottom: 2px solid #000 !important; background: #f7f6f6;">
														...
														<td>
															<?=$all_in_course?>
															<?php $all_in_view += $all_in_course;?>
														</td>
														<td>
															<?=$all_womens_in_course?>
															<?php $all_womens_in_view += $all_womens_in_course;?>
														</td>
														<td>
															<?=$all_mens_in_course?>
															<?php $all_mens_in_view += $all_mens_in_course;?>
														</td>
														<!-- Шумораи донишҷӯён-->
														...
														<td>
															<?=$a_i_c_sh + $a_i_c_sh_w;?>
															<?php $a_i_v_sh_m += $a_i_c_sh + $a_i_c_sh_w?>
														</td>
														
														<td>
															<?=$a_i_c_sh_w?>
															<?php $a_i_v_sh_w += $a_i_c_sh_w?>
														</td>
														
														<td>
															<?=$a_i_c_sh;?>
															<?php $a_i_v_sh += $a_i_c_sh;?>
														</td>
														...
														<td>
															<?=$a_i_c_b_w?>
															<?php $a_i_v_b_w += $a_i_c_b_w?>
														</td>
														<td>
															<?=$a_i_c_b + $a_i_c_b_w;?>
															<?php $a_i_v_b_m += $a_i_c_b - $a_i_c_b_w?>
														</td>
														<!-- Буҷавӣ-->
														...
														<td>
															<?=$a_i_c_k_w?>
															<?php $a_i_v_k_w += $a_i_c_k_w?>
														</td>
														<td>
															<?=$a_i_c_k - $a_i_c_k_w;?>
															<?php $a_i_v_k_m += $a_i_c_k - $a_i_c_k_w?>
														</td>
														<!-- Квота-->
													</tr>
												...
												<tr class="center bold" style="border-bottom: 2px solid #000 !important;">
													...
													<td>
														<?=$all_in_view?>
														<?php $all_in_facs += $all_in_view?>
													</td>
													<td>
														<?=$all_womens_in_view?>
														<?php $all_womens_in_facs += $all_womens_in_view;?>
													</td>
													<td>
														<?=$all_mens_in_view?>
														<?php $all_mens_in_facs += $all_mens_in_view;?>
													</td>
													<!-- Шумораи донишҷӯён-->
													...
													<td>
														<?=$a_i_v_sh_m?>
														<?php $a_i_f_sh_m += $a_i_v_sh_m?>
														
													</td>
													<td>
														<?=$a_i_v_sh_w?>
														<?php $a_i_f_sh_w += $a_i_v_sh_w?>
													</td>
													
													
													<td>
														<?=$a_i_v_sh?>
														<?php $a_i_f_sh += $a_i_v_sh;?>
											...
											<tr class="center bold" style="border-bottom: 2px solid #000 !important;">
												...
												<td>
													<?=$all_in_facs?>
													<?php $all_in_ddmit += $all_in_facs;?>
												</td>
												<td>
													<?=$all_womens_in_facs?>
													<?php $all_womens_in_ddmit += $all_womens_in_facs;?>
												</td>
												<td>
													<?=$all_mens_in_facs?>
													<?php $all_mens_in_ddmit += $all_mens_in_facs;?>	
												</td>
												<!-- Шумораи донишҷӯён-->
												<!-- Шартномавӣ-->
												<td>
													<?=$a_i_f_sh_m?>
													<?php $a_i_ddmit_sh_m += $a_i_f_sh_m;?>
												</td>
												<td>
													<?=$a_i_f_sh_w?>
													<?php $a_i_ddmit_sh_w += $a_i_f_sh_w;?>
												</td>
												<td>
													<?=$a_i_f_sh?>
													<?php $a_i_ddmit_sh +=$a_i_f_sh;?>
												</td>
												<!-- Шартномавӣ-->
