...
<table class="addform testcase" style="width: 100%">	
	<tr>
		...
		<td style="width:20%">
			<label for="intixobi">Фани интихобист?:</label>
			<select name="intixobi[]" id="intixobi" class="form-control">
				<option value="0">Фани интихоби нест</option>
				<option value="1">Фани интихоби ҳаст!</option>
			</select>
		</td>
