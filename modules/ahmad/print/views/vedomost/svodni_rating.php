		...
		<table style="width:100%;">
			<tr class="bold">
				...
				<td style="vertical-align: top; text-align: center">
					...
					<br>
					<br>
					Варақаи ҷамбастии имтиҳонотӣ-рейтингӣ №<?=$rating?><br>
					Общая экзаменационно-рейтинговая ведомость №<?=$rating?><br>
			...
			<tbody>
				...
				<?php foreach($students as $item):?>
					<tr>
						...
						<?php foreach($fanlist as $f_item):?>
							<?php $score = getNF2($rating, $item['id'], $f_item['id_fan'], $S_Y, $H_Y);?>
