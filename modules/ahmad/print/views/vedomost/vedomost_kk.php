		...
		<table style="width:100%;">
			<tr class="bold">
				...
				<td style="vertical-align: top; text-align: center">
					...
					<br>
					<br>
					<?php// print_arr($data_iq)?>		
					<?php if($data_iq[0]['loihai_kursi']):?>
						Варақаи лоиҳаи курсӣ №ЛК-<?=$data_iq[0]['id']."/".$S_Y;?> <br>
						Проектно-курсовая ведомость №ЛК-<?=$data_iq[0]['id']."/".$S_Y;?> <br>
					<?php endif;?>
					<?php if($data_iq[0]['kori_kursi']):?>
						Варақаи кори курсӣ №КК-<?=$data_iq[0]['id']."/".$S_Y;?><br>
						Ведомость курсовая работа №КК-<?=$data_iq[0]['id']."/".$S_Y;?> <br>
					<?php endif;?>
			...
			<tbody>
				...
				<?php foreach($students as $item):?>
					...
					<tr>
						...
						<td class="center">
							<?=$score = getKK($item['id'], $id_fan, $S_Y, $H_Y);?>
						</td>
