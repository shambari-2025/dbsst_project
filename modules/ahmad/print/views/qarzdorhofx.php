			...
			<?php foreach($study_view as $s_v):?>
				...
				<table class="table transcript" style="width:100%;">
					...
					<?php foreach($facs as $fac):?>
						<tr class="center">
							<td colspan="5" style="font-weight: bold;">Факултети "<?=getFaculty($fac['id_faculty']);?>"</td>
						</tr>
								...
								<?php foreach($groups as $g):?>
									...
									<?php foreach($students as $std):?>
										...
										<?php $results = query("SELECT id_fan, `total_score`
																...
																GROUP BY `id_fan`, `total_score` HAVING total_score >= '45.00' AND total_score < '50.00' ORDER BY `id_fan`");?>
