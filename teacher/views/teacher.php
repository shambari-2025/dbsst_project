...
<html lang="en">
	...
	<body>
        ...
        <script src="<?=TMPL_URL?>js/jquery-3.6.0.js" data-cf-settings="d8424a08d31b5b8b406fded2-|49" defer=""></script>
        
        <script src="http://asu.tut.tj/views/js/jquery-3.6.0.js"></script>
